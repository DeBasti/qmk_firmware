 ...
 */
    [_base] = LAYOUT_split_3x5_3_encoder(
        ...
        KC_Y,    KC_X,    AC_C,    KC_D,    AC_V, XXXXXXX,                                 XXXXXXX, KC_K,    KC_H,    KC_COMM, KC_DOT,  LSFT(KC_MINUS),
                    LT(_nav,KC_SPC), LT(_num,KC_TAB), winLeft,                        winRight, LT(_sym,KC_ENT),  LSFT_T(KC_BSPC)
    ),
 ...
 */
    ...
    [_sym] = LAYOUT_split_3x5_3_encoder(
...
/*
  ...
  *                        `----------------------------------'  `----------------------------------'
  */
     [_num] = LAYOUT_split_3x5_3_encoder(
 ...
 *                        `----------------------------------'  `----------------------------------'
 */
    [_son] = LAYOUT_split_3x5_3_encoder(
...
//  *                        `----------------------------------'  `----------------------------------'
//  */
//     [_LAYERINDEX] = LAYOUT_split_3x5_3_encoder(
//       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
//       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
